...
| source HOLD manual review 부담 | DONE·admitted 0 | manual check 5 정적판정(search 쿼리 KEEP_HOLD 3·example.com placeholder REJECT 2). fixture라 실 ADMIT 대상 없음→ingest BLOCKED 유지. 실 운영 source URL이면 license/robots 확인 후 ADMIT. fetch/network 0. |
